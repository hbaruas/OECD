...
SAMPLE_FRACTION = 1.0  #meaning if you want to sample 10% of the data, set this to 0.1. For full dataset, set to 1.0
...
#as we only have 2023 SUT data, we will use that as the base year for all calculations
SUT_YEAR = 2023
ALPHA_LOW = 1.58
